...
<div class="page">
    ...
    <main class="page__content">
        <div class="dashboard__intro">
            ...
            <p class="muted">Ultima actualizacion: {{ \Illuminate\Support\Carbon::parse($updatedAt)->locale('es')->isoFormat('L LTS') }}</p>
        </div>
        @php
        ...
        <div class="card-grid">
            ...
            <a class="card module-card" href="#">Hacer Snapshot completo del servidor</a>
            <!-- Estadísticas del servidor -->
            <div class="card"><span class="stat__label">Carga 1 min</span><div class="stat__value">{{ data_get($metrics, 'snapshot.load_1m', 'Sin datos') }}</div></div>
            <div class="card"><span class="stat__label">Memoria usada</span><div class="stat__value">{{ $memoryUsed === null ? 'Sin datos' : $memoryUsed . '%' }}</div></div>
            <div class="card"><span class="stat__label">Contenedores</span><div class="stat__value">{{ $containers->count() }}</div></div>
        </div>
